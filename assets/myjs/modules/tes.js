    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            if( eror == 1){
                ...
                let msg_opening = CKEDITOR.instances['form-opening-add'].getData();
                Object.assign(formData, {'msg_opening': msg_opening})
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            if( eror == 1){
                ...
                let msg_opening = CKEDITOR.instances['form-opening-edit'].getData();
                Object.assign(formData, {'msg_opening': msg_opening})
                
                let msg = CKEDITOR.instances['form-text-edit'].getData();
                Object.assign(formData, {'msg': msg})
