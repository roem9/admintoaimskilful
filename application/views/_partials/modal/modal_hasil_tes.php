        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="nim" class="form form-control">
                    <label>NIM</label>
                </div>
                <div class="form-floating mb-3">
                ...
                <div class="form-floating mb-3">
                    <textarea name="tujuan_tes" class="form form-control required"></textarea>
                    <label>Tujuan Mengikuti Tes TOEFL</label>
                </div>
                <div class="form-floating mb-3">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="nilai_listening" class="form form-control required">
                    <label>Nilai Listening</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="nilai_structure" class="form form-control required">
                    <label>Nilai Structure</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="nilai_reading" class="form form-control required">
