                ...
                <form class="user" id="formAddTes">
                    ...
                    <div class="form-floating mb-3">
                        <select name="tipe_tes" class="form form-control required">
                            ...
                            <option value="Tes TOEFL Aimskilful">Tes TOEFL Aimskilful</option>
                            <option value="Tes TOEFL Kolaborasi Perusahaan">Tes TOEFL Kolaborasi Perusahaan</option>
                            <option value="Tes TOEFL Kolaborasi Universitas">Tes TOEFL Kolaborasi Universitas</option>
                        </select>
                    ...
                    <div class="mb-3">
                        <label class="mb-3">Pesan Opening</label>
                        <textarea name="msg" class='ckeditor' id='form-opening-add'></textarea>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="mb-3">Pesan Opening</label>
                    <textarea name="msg" class='ckeditor' id='form-opening-edit'></textarea>
                </div>
